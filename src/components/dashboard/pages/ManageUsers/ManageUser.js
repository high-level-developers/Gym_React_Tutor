...
import { getMainGymIDByUser } from "../../../../fiebaseImp/js/gym_main";
...
const ManageUser = ()=> {
    ...
    const onSearch = (e) =>{
        ...
        let temp = [];
        users.forEach( item=> {
            if(item.username && item.username.toLowerCase().includes(e.toLowerCase())){
                temp.push(item);
            }
        });
        setContent(temp);
    ...
    return(
        <Container>
            ...
            <div className="content-layout">
                ...
                <div className="content">
                    <div className="table-header">
                        ...
                        <span className="membership">
                            {!role.includes(3) && role.includes(4) && t('Membership')}
                        </span>
            ...
            <AddUser isOpen={isAdd} role={role} gymID={mainGymID} close={closeAddModal} memberships={memberships}
               refresh={getUsers} />
        </Container>
    )
}
