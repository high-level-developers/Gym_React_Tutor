...
import Addgymbranch from "../ManageGymBranch/modal/addgymbranch";
// import EditGym from "../ManageGymBranch/GymBranch/editGymModal";
import {  changeGymActivation, getGyms } from "../../../../fiebaseImp/js/gym_main";
        ...
        <React.Fragment>
            <div className="table-row" >
                <div className="gymImage">
                    <img src={content.tradeLicenseFilePath ? content.tradeLicenseFilePath : undefined} className="image-gym" alt="trade license"/>
                </div>
                ...
                {content.tradeLicenseExpiryDate ? formatDate(content.tradeLicenseExpiryDate.seconds * 1000) : ''}
                </span>
                <div className="controls">
                    <Link className="edit" to="/gymdetail" state={{id:content.qrCode}}>
                        <RiPencilFill/>
                    </Link>
                    <span className={content.activated? "activate": "activate disable"}
                        onClick={()=>{
                            changeGymActivation(content.qrCode, !content.approved);
                            refresh();
                        }}>
            ...
            <div className="table-row-mobile">
                <div className="info">
                    <div>
                        <img src={content.tradeLicenseFilePath} className="image-gym" alt="tradeImage"/>
                    </div>
                    <div className="text">
                        <span className="gymname">
                            {content.name}
...
const ManageGymBranch = ()=>{
    ...
    return(
        <Container>
            ...
            {/*<Addgymbranch isOpen={isAdd} close={closeAddModal} refresh={getAllGyms} />*/}
        </Container>
    );
}
