  ...
  return (
    <div>
      <Container>
        ...
        <div className="menuLayout">
          ...
          {localStorage.getItem("isAuthenticated") && (
            <React.Fragment>
              <NavLink selected={false} onClick={() => {}}>
                <span>
                  {" "}
                  {JSON.parse(localStorage.getItem("profile")).sure_name}{" "}
                </span>
              </NavLink>
              <NavLink
                selected={false}
      ...
      <Login
        ...
        close={onLogin}
        openSignup={onSignup}
        openResetPassword={onResetPassword}
      />
      <Signup isOpen={openSignup} close={onSignup} openLogin={onLogin} />
      <ResetPassword isOpen={openResetPassword} close={onResetPassword} />
    </div>
  );
};
