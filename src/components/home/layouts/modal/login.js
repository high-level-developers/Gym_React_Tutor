...
import { logInWithEmailAndPassword, loginwithGoogleAccount, loginWithApple } from "../../../../fiebaseImp/js/firebaseAuth";
...
const Login = (props)=>{
    ...
    const navigateUser = (roles) => {
        if ([3,4,6].some((i) => roles.includes(i))) {
            navigate('/dashboard');
        }else {
            navigate('/settings');
        }
    ...
    const onLogin = ()=>{
        ...
        .then(data =>{
            ...
            if(data.error !== ''){
                ...
                hideModal();
                navigateUser(data.profile.role);
                ...
                <Container>
                    ...
                    <FadeIn delay={100}
                        ...
                        <div className="label-layout">
                            ...
                            <span className="label label-hover" onClick={onForgetPassword}>
                                {t('Forgot password?')}
                            </span>
                        </div>
