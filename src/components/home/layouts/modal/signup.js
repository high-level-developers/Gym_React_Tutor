...
import { signUpWithEmailAndPassword, emailVerification } from "../../../../fiebaseImp/js/firebaseAuth";
...
const Signup = (props)=>{
    ...
    const [email, setEmail] = useState("aaaa.bbbb21@mail.ru");
            ...
            >
                <Container>
                    <div className="social">
                        ...
                        <div>
                            ...
                            <div className="social-group">
                                <div className={step === 5? 'button active' : 'button'}
                                    onClick={()=>onStep(5)}>
                    ...
                    <FadeIn delay={100}
                        ...
                        <div className="label label-desc1">
                            {t(`User E-mail: ${email}`)}
                        </div>                        
                        <div className="label label-desc2">
                            {t(`Verified: ${isVerified ? 'verified': 'not yet'}`)}
                        </div>                        
                        <div className={error? "error-msg active": "error-msg"}>
                            {error}
                        </div>
                        <div className="button-layout" style={{marginTop: '0px'}}>
                            <StyledButton active={true} className="button"
                                onClick={onNextStep}>
                                {t('Verify E-Mail')}
                            </StyledButton>
                    ...
                    <FadeIn delay={100}
                        ...
                        <div className="label-verification">
                            <span className="default-color">{t('User E-mail: ')}</span><span className="white-color label-bold">{t(`${email}`)}</span>
                        </div>
                    ...
                    <FadeIn delay={100}
                        className={step ===5? "setting" : "setting disable"}
                        transitionDuration={300} visible={step === 5}>
                        <div className="title"
                            style={{marginBottom: '0px'}}
                        >
