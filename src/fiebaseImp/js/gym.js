...
export const saveGym = (id, name, address, location, userID, visitCost, attendanceCost, mainBranchID)=>{
...
export const updateGym = (id, name, owner, membership="", visitCost, attendCost) =>{
